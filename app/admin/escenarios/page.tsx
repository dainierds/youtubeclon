...
export default async function AdminScenariosPage() {
  ...
  // 1. Obtener todos los escenarios
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-extrabold text-white">Escenarios de Simulación</h1>
          <p className="text-sm text-slate-400">Diseña, edita y publica las prácticas de cableado para la academia.</p>
        </div>
        <Link
              ...
              scenarios.map((scenario) => (
                <tr key={scenario.id} className="hover:bg-slate-850 transition">
                  ...
                  <td className="px-6 py-4 flex gap-3">
                    <Link
                      href={`/admin/escenarios/${scenario.id}/editar`}
