    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-950 text-white p-6">
        <div className="text-center p-8 border border-red-900 bg-red-950/20 rounded-2xl shadow-xl max-w-md">
          ...
          <p className="text-sm text-slate-400">No tienes permisos de Administrador para acceder a esta sección.</p>
    ...
    <div className="flex min-h-screen bg-slate-950 text-slate-100">
      ...
      <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col">
        <div className="p-6 border-b border-slate-800">
          ...
          <span className="text-[10px] text-red-400 uppercase tracking-widest font-mono">Super Admin</span>
        </div>
