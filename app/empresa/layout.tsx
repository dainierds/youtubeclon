    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-950 text-white p-6">
        <div className="text-center p-8 border border-red-900 bg-red-950/20 rounded-2xl shadow-xl max-w-md">
          ...
          <p className="text-sm text-slate-400">Esta sección es exclusiva para administradores de empresas.</p>
    ...
    <div className="flex min-h-screen bg-slate-950 text-slate-100">
      ...
      <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col">
        <div className="p-6 border-b border-slate-800">
          ...
          <span className="text-[10px] text-blue-400 uppercase tracking-widest font-mono">Empresa</span>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <Link 
            href="/empresa/tecnicos" 
            className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-slate-800 transition"
          >
            Técnicos
          </Link>
          <Link 
            href="/empresa/escenarios" 
            className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-slate-800 transition"
          >
            Escenarios
          </Link>
          <Link 
            href="/empresa/reporte" 
            className="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-slate-800 transition"
          >
            Reporte de Riesgo
          </Link>
